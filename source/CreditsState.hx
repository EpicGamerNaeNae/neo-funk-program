...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Softhands',			'magnus',			'Co-Director/Musician',									'https://www.youtube.com/channel/UCZP_hnjrel_mUV9k8jNBJvg',	'C13E3E'],
			['v1corp',				'magnus',			'Lead Musician',										'https://twitter.com/corp_v1',	'C13E3E'],
			['Bonk',				'magnus',			'Animator',												'https://twitter.com/epicgamernaenae',	'C13E3E'],
			['Timson',				'magnus',			'Lead Charter',											'https://twitter.com/Timson79795725',	'C13E3E'],
			['BlonicLikesToParty ',	'magnus',			'Logo Designer',										'https://www.youtube.com/channel/UCCAIW6w-Bm8lNwlzsAIar7Q',	'C13E3E'],
			['Loxowoo',				'magnus',			'Icon Designer/Sprite Artist',							'https://twitter.com/loxxxvv',	'C13E3E'],
			['Hi_Im_Just_Here',		'justhere',			'Background Artist',									'https://twitter.com/epicgamernaenae',	'057E93'],
			[''],
			['Psych Engine Team'],
