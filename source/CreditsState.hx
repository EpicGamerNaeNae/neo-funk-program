...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Softhands',			'softhands',		'Co-Director/Musician',									'https://www.youtube.com/channel/UCZP_hnjrel_mUV9k8jNBJvg',	'C13E3E'],
			['v1corp',				'v1',				'Lead Musician',										'https://twitter.com/corp_v1',			'C13E3E'],
			...
			['BlonicLikesToParty ',	'blonic',			'Logo Designer',										'https://www.youtube.com/channel/UCCAIW6w-Bm8lNwlzsAIar7Q',	'C13E3E'],
