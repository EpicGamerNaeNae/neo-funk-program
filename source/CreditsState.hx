...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Zeo',					'zeo',				'Charter',												'https://www.youtube.com/channel/UCD8mU7uQmzSmbEgKIIEkQPA',	'308CD0'],
			['IceDoki',				'doki',				'Co-Director/Musician/Background Artist',				'https://www.youtube.com/channel/UCy0bZwtbzikxOPTbnYqgFKw',	'FFFAD5'],
